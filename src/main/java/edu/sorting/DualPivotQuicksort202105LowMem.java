 ...
 * @since 1.7 * 14
 */
public final class DualPivotQuicksort202105LowMem {

    private final static boolean TRACE = false;
    private final static boolean TRACE_ALLOC = false;

    private final static boolean NO_ALLOC_BUFFER = true;
     ...
     */
    private DualPivotQuicksort202105LowMem() {
    }
    ...
    private static void sort(Sorter sorter, int[] a, int bits, int low, int high) {
        while (true) {
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                ...
                if (!NO_ALLOC_BUFFER && (true /* || sorter == null*/ || bits > DELTA4) && size > RADIX_MIN_SIZE) {
...
//        }
    ...
    static final class Sorter {
        ...
        void initBuffers(final int length, final int offset) {
            if (!NO_ALLOC_BUFFER && ((b == null) || (b.length < length))) {
                if (TRACE_ALLOC) {
